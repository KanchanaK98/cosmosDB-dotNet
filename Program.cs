...
//register ICarService and CarService into program.cs
builder.Services.AddSingleton<ICarService>(options =>
{
    ...
    return new CarService(cosmosClient, dbName, containerName);
});
